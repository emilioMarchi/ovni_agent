        ...
        try {
            ...
            if (effectiveAction === "schedule") {
                ...
                if (!availableSlots.includes(normalizedTime))
                    return `⛔ El horario ${normalizedTime} ya no está disponible para el ${formatFriendlyDate(cleanDate)}. Por favor elige otro.`;
...
//# sourceMappingURL=appointment_manager.js.map